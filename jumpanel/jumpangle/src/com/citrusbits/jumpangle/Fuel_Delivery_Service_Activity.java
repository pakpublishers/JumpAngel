...
public class Fuel_Delivery_Service_Activity extends Activity {
	...
	FuelDeliveryJump BJ=new FuelDeliveryJump();
	
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		super.onCreate(savedInstanceState);
		setContentView(R.layout.fuel_delivery_service_view);
		initiateControls();
		initiateListners();
	}
	...
	private void initiateListners() {
		...
		BJLightDutyCheckBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
			...
			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
				BJ.setGasoline_Pertol(isChecked);
