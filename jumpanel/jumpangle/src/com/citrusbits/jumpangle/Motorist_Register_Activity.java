...
public class Motorist_Register_Activity extends Activity {
	...
	{
		UpdateUserProgressDialog=new ProgressDialog(Motorist_Register_Activity.this);
				...
				final Handler h=new Handler()
				{
					...
					public void handleMessage(Message m)
					{
						...
						case 1:
						{
							...
							Intent MainActivityintent=new Intent(Motorist_Register_Activity.this, MainActivity.class);
					...
					public void run()
					{
						...
						try
						{
							if(Response!=null && Response.getString("error").equals("false"))
							{
								...
								m.setLong(ResponseData.getString("long"));
